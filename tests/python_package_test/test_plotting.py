...
class TestBasic(unittest.TestCase):
    def setUp(self):
        ...
        self.params = {"objective": "binary", "verbose": -1, "num_leaves": 3}
    ...
    def test_plot_importance(self):
        ...
        for patch in ax1.patches:
            self.assertTupleEqual(patch.get_facecolor(), (1.0, 0, 0, 1.0))  # red
        ...
        self.assertTupleEqual(ax2.patches[0].get_facecolor(), (1.0, 0, 0, 1.0))  # r
        self.assertTupleEqual(ax2.patches[1].get_facecolor(), (0.75, 0.75, 0, 1.0))  # y
        self.assertTupleEqual(ax2.patches[2].get_facecolor(), (0, 0.5, 0, 1.0))  # g
        self.assertTupleEqual(ax2.patches[3].get_facecolor(), (0, 0, 1.0, 1.0))  # b
    ...
    def test_plot_split_value_histogram(self):
        ...
        self.assertIsInstance(ax0, matplotlib.axes.Axes)
        self.assertEqual(
            ax0.get_title(), "Split value histogram for feature with index 27"
        )
        ...
        self.assertRaises(
            ValueError, lgb.plot_split_value_histogram, gbm0, 0
    ...
    def test_plot_metrics(self):
        ...
        ax0 = lgb.plot_metric(
            evals_result0, metric="binary_logloss", dataset_names=["v2"]
        )
