...
class TruncatingOperatorFactory : public ExpressionFactory {
 ...
 private:
  ...
  virtual const Expression &CreateExpression(
    ...
    ProgramParseState::ExpressionParseState opState(m_factory, p_state.m_atom,
                                                    p_state.m_offset);
...
const FreeForm2::ExpressionFactory &FreeForm2::Arithmetic::GetPlusInstance() {
  return c_plusFactory;
}

const FreeForm2::ExpressionFactory &FreeForm2::Arithmetic::GetMinusInstance() {
...
const FreeForm2::ExpressionFactory &FreeForm2::Arithmetic::GetModInstance() {
  return c_modFactory;
}

const FreeForm2::ExpressionFactory &FreeForm2::Arithmetic::GetMaxInstance() {
  return c_maxFactory;
}

const FreeForm2::ExpressionFactory &FreeForm2::Arithmetic::GetMinInstance() {
  return c_minFactory;
}

const FreeForm2::ExpressionFactory &FreeForm2::Arithmetic::GetPowInstance() {
  return c_powFactory;
}
...
const FreeForm2::ExpressionFactory &FreeForm2::Arithmetic::GetLog1Instance() {
  return c_log1Factory;
}

const FreeForm2::ExpressionFactory &FreeForm2::Arithmetic::GetAbsInstance() {
  return c_absFactory;
}

const FreeForm2::ExpressionFactory &FreeForm2::Arithmetic::GetRoundInstance() {
  return c_roundFactory;
}

const FreeForm2::ExpressionFactory &FreeForm2::Arithmetic::GetTruncInstance() {
