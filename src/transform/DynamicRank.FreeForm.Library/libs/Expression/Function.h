...
class FunctionExpression : public Expression {
 public:
  ...
  FunctionExpression(const Annotations &p_annotations,
                     const FunctionType &p_type, const std::string &p_name,
...
class FunctionCallExpression : public Expression {
 public:
  ...
  static boost::shared_ptr<FunctionCallExpression> Alloc(
...
class ReturnExpression : public Expression {
 public:
  ...
  ReturnExpression(const Annotations &p_annotations, const Expression &p_value);
