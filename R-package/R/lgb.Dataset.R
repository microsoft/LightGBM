...
#'                      cannot be changed after it has been constructed. If you'd prefer to be able to change the Dataset
#'                      object after construction, set \code{free_raw_data = FALSE}.
