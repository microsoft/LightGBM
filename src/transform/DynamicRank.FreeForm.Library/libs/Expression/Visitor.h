...
namespace FreeForm2
{
    ...
    public:
        ...
        // a normal visitation is intended, and manually do the visitation return true if it will manage the
        // visitation itself.
        ...
        virtual bool AlternativeVisit(const SelectNthExpression&)
        {
            return false;
        }
        ...
        virtual bool AlternativeVisit(const SelectRangeExpression&)
        {
            return false;
        }
        ...
        virtual bool AlternativeVisit(const ConditionalExpression&)
        {
            return false;
        }
        ...
        virtual bool AlternativeVisit(const LetExpression&)
        {
            return false;
        }
        ...
        virtual bool AlternativeVisit(const BlockExpression&)
        {
            return false;
        }
        ...
        virtual bool AlternativeVisit(const RangeReduceExpression&)
        {
            return false;
        }
 
        virtual void Visit(const ForEachLoopExpression&) = 0;
        virtual bool AlternativeVisit(const ForEachLoopExpression&)
        {
            return false;
        }
        ...
        virtual bool AlternativeVisit(const MutationExpression&)
        {
            return false;
        }
        ...
        virtual bool AlternativeVisit(const MatchExpression&)
        {
            return false;
        }
        ...
        virtual bool AlternativeVisit(const MatchGuardExpression&)
        {
            return false;
        }
  
        virtual void Visit(const MatchBindExpression&) = 0;
        virtual bool AlternativeVisit(const MatchBindExpression&)
        {
            return false;
        }
        ...
        virtual bool AlternativeVisit(const FunctionExpression&)
        {
            return false;
        }
        ...
        virtual bool AlternativeVisit(const LiteralIntExpression&)
        {
            return false;
        }
        ...
        virtual bool AlternativeVisit(const ArrayLengthExpression&)
        {
            return false;
        }
        ...
        virtual bool AlternativeVisit(const DeclarationExpression&)
        {
            return false;
        }
        ...
        virtual bool AlternativeVisit(const ExternExpression&)
        {
            return false;
        }
        ...
        virtual bool AlternativeVisit(const LiteralBoolExpression&)
        {
            return false;
        }

        virtual void Visit(const LiteralVoidExpression&) = 0;
        virtual bool AlternativeVisit(const LiteralVoidExpression&)
        {
            return false;
        }
        ...
        virtual bool AlternativeVisit(const LiteralWordExpression&)
        {
            return false;
        }
        ...
        virtual bool AlternativeVisit(const FeatureRefExpression&)
        {
            return false;
        }
        ...
        virtual bool AlternativeVisit(const PhiNodeExpression&)
        {
            return false;
        }

        virtual void Visit(const PublishExpression&) = 0;
        virtual bool AlternativeVisit(const PublishExpression&)
        {
            return false;
        }

        virtual void Visit(const ReturnExpression&) = 0;
        virtual bool AlternativeVisit(const ReturnExpression&)
        {
            return false;
        }

        virtual void Visit(const FeatureSpecExpression&) = 0;
        virtual bool AlternativeVisit(const FeatureSpecExpression&)
        {
            return false;
        }
        ...
        virtual bool AlternativeVisit(const StreamDataExpression&)
        {
            return false;
        }
        ...
        virtual bool AlternativeVisit(const VariableRefExpression&)
        {
            return false;
        }
        ...
        virtual bool AlternativeVisit(const StateExpression&)
        {
            return false;
        }
        ...
        virtual void Visit(const ExecuteStreamRewritingStateMachineGroupExpression&) = 0;
        virtual bool AlternativeVisit(const ExecuteStreamRewritingStateMachineGroupExpression&)
        {
            return false;
        }
        ...
        virtual bool AlternativeVisit(const YieldExpression&)
        {
            return false;
        }

        virtual void Visit(const RandFloatExpression&) = 0;
        virtual bool AlternativeVisit(const RandFloatExpression&)
        {
            return false;
        }

        virtual void Visit(const RandIntExpression&) = 0;
        virtual bool AlternativeVisit(const RandIntExpression&)
        {
            return false;
        }
        
        virtual void Visit(const ThisExpression&) = 0;
        virtual bool AlternativeVisit(const ThisExpression&)
        {
            return false;
        }
        ...
        virtual bool AlternativeVisit(const DebugExpression&)
        {
            return false;
        }
        ...
        virtual size_t StackIncrement() const
        {
            return 0;
        }
    };
