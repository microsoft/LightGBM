 ...
 */
LIGHTGBM_C_EXPORT SEXP LGBM_HandleIsNull_R(SEXP handle);
 ...
 */
LIGHTGBM_C_EXPORT SEXP LGBM_DatasetCreateFromFile_R(SEXP filename, SEXP parameters,
                                                    SEXP reference);
 ...
 * \return Dataset handle
 */
LIGHTGBM_C_EXPORT SEXP LGBM_DatasetCreateFromCSC_R(SEXP indptr, SEXP indices, SEXP data,
                                                   SEXP num_indptr, SEXP nelem, SEXP num_row,
 ...
 * \return Dataset handle
 */
LIGHTGBM_C_EXPORT SEXP LGBM_DatasetCreateFromMat_R(SEXP data, SEXP num_row, SEXP num_col,
                                                   SEXP parameters, SEXP reference);
 ...
 * \return Dataset handle
 */
LIGHTGBM_C_EXPORT SEXP LGBM_DatasetGetSubset_R(SEXP handle, SEXP used_row_indices,
 ...
 */
LIGHTGBM_C_EXPORT SEXP LGBM_DatasetSetFeatureNames_R(SEXP handle, SEXP feature_names);
 ...
 * \return R NULL value
 */
LIGHTGBM_C_EXPORT SEXP LGBM_DatasetSaveBinary_R(SEXP handle, SEXP filename);
 ...
 * \return R NULL value
 */
LIGHTGBM_C_EXPORT SEXP LGBM_DatasetSetField_R(SEXP handle, SEXP field_name, SEXP field_data,
                                              SEXP num_element);
 ...
 * \return R NULL value
 */
LIGHTGBM_C_EXPORT SEXP LGBM_DatasetGetFieldSize_R(SEXP handle, SEXP field_name, SEXP out);
 ...
 * \return R NULL value
 */
LIGHTGBM_C_EXPORT SEXP LGBM_DatasetGetField_R(SEXP handle, SEXP field_name, SEXP field_data);
 ...
 * \return R NULL value
 */
LIGHTGBM_C_EXPORT SEXP LGBM_DatasetUpdateParamChecking_R(SEXP old_params, SEXP new_params);
 ...
 * \return R NULL value
 */
LIGHTGBM_C_EXPORT SEXP LGBM_DatasetGetNumData_R(SEXP handle, SEXP out);
 ...
 * \return R NULL value
 */
LIGHTGBM_C_EXPORT SEXP LGBM_DatasetGetNumFeature_R(SEXP handle, SEXP out);
 ...
 * \return R NULL value
 */
LIGHTGBM_C_EXPORT SEXP LGBM_DatasetGetFeatureNumBin_R(SEXP handle, SEXP feature, SEXP out);
 ...
 */
LIGHTGBM_C_EXPORT SEXP LGBM_BoosterCreate_R(SEXP train_data, SEXP parameters);
 ...
 * \return Booster handle
 */
LIGHTGBM_C_EXPORT SEXP LGBM_BoosterLoadModelFromString_R(SEXP model_str);
 ...
 */
LIGHTGBM_C_EXPORT SEXP LGBM_BoosterGetLoadedParam_R(SEXP handle);
 ...
 * \return R NULL value
 */
LIGHTGBM_C_EXPORT SEXP LGBM_BoosterMerge_R(SEXP handle, SEXP other_handle);
 ...
 * \return R NULL value
 */
LIGHTGBM_C_EXPORT SEXP LGBM_BoosterAddValidData_R(SEXP handle, SEXP valid_data);
 ...
 * \return R NULL value
 */
LIGHTGBM_C_EXPORT SEXP LGBM_BoosterResetTrainingData_R(SEXP handle, SEXP train_data);
 ...
 * \return R NULL value
 */
LIGHTGBM_C_EXPORT SEXP LGBM_BoosterResetParameter_R(SEXP handle, SEXP parameters);
 ...
 * \return R NULL value
 */
LIGHTGBM_C_EXPORT SEXP LGBM_BoosterGetNumClasses_R(SEXP handle, SEXP out);
 ...
 */
LIGHTGBM_C_EXPORT SEXP LGBM_BoosterGetNumFeature_R(SEXP handle);
 ...
 * \return R NULL value
 */
LIGHTGBM_C_EXPORT SEXP LGBM_BoosterUpdateOneIterCustom_R(SEXP handle, SEXP grad, SEXP hess,
                                                         SEXP len);
 ...
 * \return R NULL value
 */
LIGHTGBM_C_EXPORT SEXP LGBM_BoosterGetCurrentIteration_R(SEXP handle, SEXP out);
 ...
 * \return R NULL value
 */
LIGHTGBM_C_EXPORT SEXP LGBM_BoosterNumModelPerIteration_R(SEXP handle, SEXP out);
 ...
 * \return R NULL value
 */
LIGHTGBM_C_EXPORT SEXP LGBM_BoosterNumberOfTotalModel_R(SEXP handle, SEXP out);
 ...
 * \return R NULL value
 */
LIGHTGBM_C_EXPORT SEXP LGBM_BoosterGetUpperBoundValue_R(SEXP handle, SEXP out_result);
 ...
 * \return R NULL value
 */
LIGHTGBM_C_EXPORT SEXP LGBM_BoosterGetLowerBoundValue_R(SEXP handle, SEXP out_result);
 ...
 * \return R NULL value
 */
LIGHTGBM_C_EXPORT SEXP LGBM_BoosterGetEval_R(SEXP handle, SEXP data_idx, SEXP out_result);
 ...
 * \return R NULL value
 */
LIGHTGBM_C_EXPORT SEXP LGBM_BoosterGetNumPredict_R(SEXP handle, SEXP data_idx, SEXP out);
 ...
 * \return R NULL value
 */
LIGHTGBM_C_EXPORT SEXP LGBM_BoosterGetPredict_R(SEXP handle, SEXP data_idx, SEXP out_result);
 ...
 * \return R NULL value
 */
LIGHTGBM_C_EXPORT SEXP LGBM_BoosterPredictForFile_R(SEXP handle, SEXP data_filename,
 ...
 * \return R NULL value
 */
LIGHTGBM_C_EXPORT SEXP LGBM_BoosterCalcNumPredict_R(SEXP handle, SEXP num_row, SEXP is_rawscore,
                                                    SEXP is_leafidx, SEXP is_predcontrib,
                                                    SEXP start_iteration, SEXP num_iteration,
                                                    SEXP out_len);
 ...
 *               for feature contributions, its length is equal to num_class * num_data *
 * (num_features + 1)
 * \param handle Booster handle
 * \param indptr pointer to row headers
 * \param indices findex
 ...
 * \return R NULL value
 */
LIGHTGBM_C_EXPORT SEXP LGBM_BoosterPredictForCSC_R(SEXP handle, SEXP indptr, SEXP indices,
                                                   SEXP data, SEXP num_indptr, SEXP nelem,
                                                   SEXP num_row, SEXP is_rawscore, SEXP is_leafidx,
                                                   SEXP is_predcontrib, SEXP start_iteration,
 ...
 * \return R NULL value
 */
LIGHTGBM_C_EXPORT SEXP LGBM_BoosterPredictForCSR_R(SEXP handle, SEXP indptr, SEXP indices,
                                                   SEXP data, SEXP ncols, SEXP is_rawscore,
                                                   SEXP is_leafidx, SEXP is_predcontrib,
                                                   SEXP start_iteration, SEXP num_iteration,
 ...
 * \param handle Booster handle
 * \param indices array corresponding to the indices of the columns with non-zero values of the row
 * to predict on
 ...
 * \return R NULL value
 */
LIGHTGBM_C_EXPORT SEXP LGBM_BoosterPredictForCSRSingleRow_R(SEXP handle, SEXP indices, SEXP data,
                                                            SEXP ncols, SEXP is_rawscore,
                                                            SEXP is_leafidx, SEXP is_predcontrib,
...
/*!
 * \brief Initialize and return a fast configuration handle to use with
...
LIGHTGBM_C_EXPORT SEXP LGBM_BoosterPredictForCSRSingleRowFastInit_R(
    SEXP handle, SEXP ncols, SEXP is_rawscore, SEXP is_leafidx, SEXP is_predcontrib,
 ...
 * \return R NULL value
 */
LIGHTGBM_C_EXPORT SEXP LGBM_BoosterPredictForCSRSingleRowFast_R(SEXP handle_fastConfig,
                                                                SEXP indices, SEXP data,
                                                                SEXP out_result);
 ...
 *         the input data.
 */
LIGHTGBM_C_EXPORT SEXP LGBM_BoosterPredictSparseOutput_R(SEXP handle, SEXP indptr, SEXP indices,
                                                         SEXP data, SEXP is_csr, SEXP nrows,
                                                         SEXP ncols, SEXP start_iteration,
                                                         SEXP num_iteration, SEXP parameter);
 ...
 * \return R NULL value
 */
LIGHTGBM_C_EXPORT SEXP LGBM_BoosterPredictForMat_R(SEXP handle, SEXP data, SEXP num_row,
                                                   SEXP num_col, SEXP is_rawscore, SEXP is_leafidx,
                                                   SEXP is_predcontrib, SEXP start_iteration,
                                                   SEXP num_iteration, SEXP parameter,
                                                   SEXP out_result);
...
LIGHTGBM_C_EXPORT SEXP LGBM_BoosterPredictForMatSingleRow_R(
    SEXP handle, SEXP data, SEXP is_rawscore, SEXP is_leafidx, SEXP is_predcontrib,
    SEXP start_iteration, SEXP num_iteration, SEXP parameter, SEXP out_result);
 ...
 * \return R NULL value
 */
LIGHTGBM_C_EXPORT SEXP LGBM_BoosterPredictForMatSingleRowFast_R(SEXP handle_fastConfig, SEXP data,
                                                                SEXP out_result);
 ...
 * \return R NULL value
 */
LIGHTGBM_C_EXPORT SEXP LGBM_BoosterSaveModel_R(SEXP handle, SEXP num_iteration,
                                               SEXP feature_importance_type, SEXP filename,
                                               SEXP start_iteration);
 ...
 */
LIGHTGBM_C_EXPORT SEXP LGBM_BoosterSaveModelToString_R(SEXP handle, SEXP num_iteration,
 ...
 */
LIGHTGBM_C_EXPORT SEXP LGBM_BoosterDumpModel_R(SEXP handle, SEXP num_iteration,
                                               SEXP feature_importance_type, SEXP start_iteration);
 ...
 * \return R NULL value
 */
LIGHTGBM_C_EXPORT SEXP LGBM_GetMaxThreads_R(SEXP out);
 ...
 * \return R NULL value
 */
LIGHTGBM_C_EXPORT SEXP LGBM_SetMaxThreads_R(SEXP num_threads);
