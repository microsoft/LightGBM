 ...
 * license information.
 */
#ifndef LIGHTGBM_TREELEARNER_COST_EFFECTIVE_MT_GRADIENT_BOOSTING_HPP_
#define LIGHTGBM_TREELEARNER_COST_EFFECTIVE_MT_GRADIENT_BOOSTING_HPP_
...
class CostEfficientMTGradientBoosting {
 public:
  explicit CostEfficientMTGradientBoosting(const SerialMTTreeLearner* tree_learner)
 ...
 private:
  ...
  bool init_;
  const SerialMTTreeLearner* tree_learner_;
...
#endif  // LIGHTGBM_TREELEARNER_COST_MT_EFFECTIVE_GRADIENT_BOOSTING_HPP_
