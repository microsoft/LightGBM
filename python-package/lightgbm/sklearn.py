...
class LGBMModel(_LGBMModelBase):
    ...
    def __init__(self, boosting_type='gbdt', num_leaves=31, max_depth=-1,
        ...
        **kwargs
        ...
        For binary tasks, ``y_pred`` is margin.
        For multi-class tasks, ``y_pred`` is grouped by class_id first, then by row_id.
        I.e. if you want to get the prediction for the i-th sample in the j-th class, you would access it via
        ``y_pred[j * num_data + i]``, and you should group ``grad`` and ``hess`` in this way as well.
        """
