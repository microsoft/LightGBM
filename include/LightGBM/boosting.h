...
class LIGHTGBM_EXPORT Boosting {
  ...
  */
   ...
   */
  virtual void RefitTree(const int* tree_leaf_prediction, const size_t nrow,
                         const size_t ncol) = 0;
  ...
  virtual int NumPredictOneRow(int start_iteration, int num_iteration, bool is_pred_leaf,
  ...
  virtual void PredictLeafIndexByMap(const std::unordered_map<int, double>& features,
   ...
   */
  virtual std::string DumpModel(int start_iteration, int num_iteration,
                                int feature_importance_type) const = 0;
  ...
  virtual bool SaveModelToFile(int start_iteration, int num_iterations,
                               int feature_importance_type, const char* filename) const = 0;
   ...
   */
  virtual std::string SaveModelToString(int start_iteration, int num_iterations,
                                        int feature_importance_type) const = 0;
