...
class TreeLearner {
 public:
   ...
   */
  virtual Tree* FitByExistingTree(const Tree* old_tree,
   ...
   */
  virtual void AddPredictionToScore(const Tree* tree,
                                    double* out_score) const = 0;

  virtual void RenewTreeOutput(
