...
namespace FreeForm2
{
    ...
    public:
        ...
        static_assert(sizeof(ArrayBoundsType) * 8 
        ...
        static std::pair<ArrayBoundsType, ArrayCountType> 
        EncodeDimensions(const unsigned int* p_dimensions,
        ...
        static std::pair<ArrayBoundsType, ArrayCountType>
        EncodeDimensions(const ArrayType& p_type);
        ...
        // and populating p_dimensions (which will be cleared first) with the arrays dimensions.
        static ArrayCountType DecodeDimensions(ArrayBoundsType p_bounds, 
        ...
        IssueReturn(CompilationState& p_state, 
        ...
        template<typename T>
        static boost::shared_ptr<Result> 
        CreateArrayResult(const ArrayType& p_arrayType, 
                          ArrayCodeGen::ArrayBoundsType p_bounds, 
                          const boost::shared_array<T>& p_space);

        // Create an empty array of the given type.
        static LlvmCodeGenerator::CompiledValue& CreateArray(CompilationState& p_state, 
        ...
        // Create an empty array of the given type.
        static LlvmCodeGenerator::CompiledValue& CreateEmptyArray(CompilationState& p_state, 
                                                                  const ArrayType& p_arrayType);

        // Mask the given bounds to extract the top dimension.
        static LlvmCodeGenerator::CompiledValue& MaskBounds(CompilationState& p_state, 
                                                            LlvmCodeGenerator::CompiledValue& p_bounds);

        // Shift the given bounds down to remove one dimension.
        static LlvmCodeGenerator::CompiledValue& ShiftBounds(CompilationState& p_state, 
                                                             LlvmCodeGenerator::CompiledValue& p_bounds,
        ...
        static LlvmCodeGenerator::CompiledValue& UnshiftBound(CompilationState& p_state,
                                                              LlvmCodeGenerator::CompiledValue& p_bounds,
