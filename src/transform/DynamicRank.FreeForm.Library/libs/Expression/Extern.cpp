...
namespace
{
    ...
    public:
        ExternalObject(const char* p_name) 
            : ExternalData(p_name, 
                           *FreeForm2::TypeManager::GetGlobalTypeManager().GetTypeInfo(p_name))
        {
        }
...
namespace
{
    ...
    static const BuiltInObject c_numberOfTuplesCommonNoDuplicateImpl("NumberOfTuplesCommonNoDuplicate");
    static const BuiltInObject c_numberOfTuplesInTriplesCommonImpl("NumberOfTuplesInTriplesCommon");
    static const BuiltInObject c_alterationAndTermWeightImpl("AlterationAndTermWeightingCalculator");
    static const BuiltInObject c_alterationWeightImpl("AlterationWeightingCalculator");
...
FreeForm2::ExternExpression::c_numberOfTuplesCommonObject = c_numberOfTuplesCommonImpl;
const FreeForm2::ExternExpression::BuiltInObject& 
FreeForm2::ExternExpression::c_numberOfTuplesCommonNoDuplicateObject = c_numberOfTuplesCommonNoDuplicateImpl;
const FreeForm2::ExternExpression::BuiltInObject& 
FreeForm2::ExternExpression::c_numberOfTuplesInTriplesCommonObject = c_numberOfTuplesInTriplesCommonImpl; 
const FreeForm2::ExternExpression::BuiltInObject& 
FreeForm2::ExternExpression::c_alterationAndTermWeightObject = c_alterationAndTermWeightImpl;
const FreeForm2::ExternExpression::BuiltInObject& 
FreeForm2::ExternExpression::c_alterationWeightObject = c_alterationWeightImpl;
const FreeForm2::ExternExpression::BuiltInObject& 
FreeForm2::ExternExpression::c_trueNearDoubleQueueObject = c_trueNearDoubleQueueImpl;
const FreeForm2::ExternExpression::BuiltInObject& 
...
FreeForm2::ExternExpression::GetObjectByName(const std::string& p_name)
{
    ...
    BOOST_FOREACH(const FreeForm2::ExternExpression::BuiltInObject* const obj, c_objects)
    {
...
const FreeForm2::ExternalData&
FreeForm2::ExternExpression::GetObjectData(const BuiltInObject& p_object)
{
    return p_object.m_object;
}


FreeForm2::ExternExpression::ExternExpression(
      ...
      m_id(p_id)
{
    if (m_data.GetType() != p_declaredType)
    {
        ...
        err << "Incorrect type for external data member " 
            << m_data.GetName() << ". Expected type " 
            << m_data.GetType() << "; found type " 
            << p_declaredType;
...
FreeForm2::ExternExpression::ExternExpression(
    ...
    : Expression(Annotations(p_annotations.m_sourceLocation,
                             p_object.m_object.IsCompileTimeConstant()
                                ? ValueBounds(p_object.m_object.GetType(), p_object.m_object.GetCompileTimeValue())
...
void
FreeForm2::ExternExpression::Accept(Visitor& p_visitor) const
{
...
size_t
FreeForm2::ExternExpression::GetNumChildren() const
{
    return 0;
}
...
FreeForm2::ExternExpression::GetType() const
{
...
bool
FreeForm2::ExternExpression::IsConstant() const
{
...
FreeForm2::ExternExpression::GetConstantValue() const
{
...
const FreeForm2::ExternalData&
FreeForm2::ExternExpression::GetData() const
{
    return m_data;
}
...
FreeForm2::ExternExpression::GetId() const
{
    return m_id;
}
