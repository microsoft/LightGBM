...
class FeatureRefExpression : public Expression {
 public:
  FeatureRefExpression(const Annotations &p_annotations, UInt32 p_index);
...
class VariableRefExpression : public Expression {
 public:
  ...
  VariableRefExpression(const Annotations &p_annotations, VariableID p_id,
...
class ThisExpression : public Expression {
 public:
  ...
  ThisExpression(const Annotations &p_annotations, const TypeImpl &p_type);
