...
bool FeatureMapGetFeatureIndex(MinimalFeatureMap *featureMap,
...
bool FeatureMapGetFeatureName(MinimalFeatureMap *featureMap,
                              UInt32 featureIndex, char *featureNameBuffer,
                              UInt32 sizeOfBuffer, UInt32 *featureNameLength) {
