...
void 
FreeForm2::MatchExpression::Accept(Visitor& p_visitor) const
{
...
FreeForm2::MatchExpression::GetType() const
{
...
size_t 
FreeForm2::MatchExpression::GetNumChildren() const
{
    return 3;
}
...
FreeForm2::MatchExpression::GetValue() const
{
    return m_value;
}


const FreeForm2::MatchSubExpression& 
FreeForm2::MatchExpression::GetPattern() const
{
    return m_pattern;
}
...
const FreeForm2::Expression& 
FreeForm2::MatchExpression::GetAction() const
{
    return m_action;
}
...
bool
FreeForm2::MatchExpression::IsOverlapping() const
{
...
void 
FreeForm2::MatchOperatorExpression::Accept(Visitor& p_visitor) const
{
    size_t stackSize = p_visitor.StackSize();
...
const FreeForm2::TypeImpl&
FreeForm2::MatchOperatorExpression::GetType() const
{
    return TypeImpl::GetVoidInstance();
}
...
size_t 
FreeForm2::MatchOperatorExpression::GetNumChildren() const
{
...
FreeForm2::MatchOperatorExpression::GetInfo() const
{
    switch (GetOperator())
    {
        ...
        {
            FF2_ASSERT(m_numChildren == 1);
            return Info(m_children[0]->GetInfo().m_minLength, 
                                          ...
                                          Operator p_op)
{
    ...
    // allocated in a char[].
    boost::shared_ptr<MatchOperatorExpression> exp(new (new char[bytes]) 
        MatchOperatorExpression(p_annotations, p_children, p_numChildren, p_op), DeleteAlloc);
    return exp;
}
...
FreeForm2::MatchOperatorExpression::MatchOperatorExpression(const Annotations& p_annotations,
                                                            const MatchSubExpression** p_children,
                                                            size_t p_numChildren,
                                                            Operator p_op)
...
void FreeForm2::MatchOperatorExpression::DeleteAlloc(MatchOperatorExpression* p_allocated)
{
...
FreeForm2::MatchGuardExpression::MatchGuardExpression(const Annotations& p_annotations,
...
void 
FreeForm2::MatchGuardExpression::Accept(Visitor& p_visitor) const
{
    size_t stackSize = p_visitor.StackSize();
...
const FreeForm2::TypeImpl&
FreeForm2::MatchGuardExpression::GetType() const
{
...
size_t 
FreeForm2::MatchGuardExpression::GetNumChildren() const
{
    return 1;
}
...
FreeForm2::MatchSubExpression::Info 
FreeForm2::MatchGuardExpression::GetInfo() const
{
    return Info(0, 0);
}


FreeForm2::MatchBindExpression::MatchBindExpression(const Annotations& p_annotations,
...
void 
FreeForm2::MatchBindExpression::Accept(Visitor& p_visitor) const
{
    size_t stackSize = p_visitor.StackSize();
...
const FreeForm2::TypeImpl& 
FreeForm2::MatchBindExpression::GetType() const
{
...
size_t 
FreeForm2::MatchBindExpression::GetNumChildren() const
{
    return 1;
}
...
FreeForm2::MatchSubExpression::Info 
FreeForm2::MatchBindExpression::GetInfo() const
{
