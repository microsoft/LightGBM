...
namespace FreeForm2
{
    ...
    public:
        ...
        Parse(SIZED_STRING p_result, TypeManager& p_typeManager);
    ...
    private:
        ...
        // error messages.
        static boost::shared_ptr<ValueResult> 
        Parse(Tokenizer& p_tok, SIZED_STRING p_original, TypeManager& p_typeManager);
