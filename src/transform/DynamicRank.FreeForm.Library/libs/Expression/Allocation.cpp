...
FreeForm2::Allocation::Allocation(AllocationType p_allocType,
                                  VariableID p_id,
...
FreeForm2::Allocation::AllocationType
FreeForm2::Allocation::GetAllocationType() const
{
    return m_allocType;
}
...
const TypeImpl&
FreeForm2::Allocation::GetType() const
{
    return m_type;
}
...
VariableID
FreeForm2::Allocation::GetAllocationId() const
{
    return m_id;
}
...
size_t
FreeForm2::Allocation::GetNumChildren() const
{
    return m_children;
}
