...
pip install -v lightgbm --no-binary lightgbm --config-settings=cmake.define.CMAKE_GENERATOR="MinGW Makefiles" --config-settings=cmake.define.CMAKE_SH=CMAKE_SH-NOTFOUND
