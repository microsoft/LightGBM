...
FreeForm2::RandFloatExpression::RandFloatExpression(const Annotations& p_annotations)
...
void
FreeForm2::RandFloatExpression::Accept(Visitor& p_visitor) const
{
...
FreeForm2::RandFloatExpression::GetType() const
{
...
size_t
FreeForm2::RandFloatExpression::GetNumChildren() const
{
    return 0;
}
...
FreeForm2::RandIntExpression::RandIntExpression(const Annotations& p_annotations,
...
void
FreeForm2::RandIntExpression::Accept(Visitor& p_visitor) const
{
    const size_t stackSize = p_visitor.StackSize();
...
const FreeForm2::TypeImpl&
FreeForm2::RandIntExpression::GetType() const
{
...
size_t
FreeForm2::RandIntExpression::GetNumChildren() const
{
    return 2;
}
