...
public:
  ...
  */
  virtual void PredictRaw(const std::vector<std::pair<int, double>>& features, double* output) const = 0;
  ...
  * \param output Prediction result for this record
  */
  virtual void Predict(const std::vector<std::pair<int, double>>& features, double* output) const = 0;
  ...
  */
  virtual void PredictLeafIndex(
    const std::vector<std::pair<int, double>>& features, double* output) const = 0;
