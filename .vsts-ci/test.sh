...
if [[ $TASK == "sdist" ]]; then
    ...
    if [[ $AGENT_OS == "Darwin" ]]; then
        ...
        cp dist/lightgbm-$LGB_VER-py2.py3-none-macdarwin.whl ${BUILD_ARTIFACTSTAGINGDIRECTORY}/lightgbm-$LGB_VER-py2.py3-none-macosx_10.6_x86_64-macosx_10.7_x86_64-macosx_10.8_x86_64-macosx_10_9_x86_64.macosx_10_10_x86_64.macosx_10_11_x86_64.macosx_10_12_x86_64.macosx_10_13_x86_64.whl
