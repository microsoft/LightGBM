    ...
    for section_name, section_params in zip(sections, descriptions):
        ...
        for param_desc in section_params:
            ...
            if checks_len > 1:
                ...
                checks_str = ''
            main_desc = '-  ``{0}`` :raw-html:`<a id="{0}" title="Permalink to this parameter" class="headerlink" href="#{0}">&#x1F517;</a>`, default = ``{1}``, type = {2}{3}{4}{5}'.format(name, default, param_type, options_str, aliases_str, checks_str)
