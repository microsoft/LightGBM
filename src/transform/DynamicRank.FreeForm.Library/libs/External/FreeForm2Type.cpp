...
FreeForm2::Type::Type(const TypeImpl& p_impl)
    : m_impl(p_impl)
{
}
...
FreeForm2::Type::Primitive() const
{
...
const char* 
FreeForm2::Type::Name(TypePrimitive p_type)
{
    switch (p_type)
    {
        ...
        case InstanceHeader: return "instanceHeader";
        case BodyBlockHeader: return "bodyBlockHeader";
...
bool
FreeForm2::Type::operator==(const Type& p_other) const
{
...
FreeForm2::Type::GetImplementation() const
{
    return m_impl;
}
...
FreeForm2::Type::TypePrimitive 
FreeForm2::Type::ParsePrimitive(SIZED_STRING p_string)
{
...
std::ostream& 
FreeForm2::operator<<(std::ostream& p_out, const Type& p_type)
{
...
const FreeForm2::TypeImpl&
FreeForm2::TypeFactory::GetUInt64Type()
{
...
const FreeForm2::TypeImpl&
FreeForm2::TypeFactory::GetInt32Type()
{
...
const FreeForm2::TypeImpl&
FreeForm2::TypeFactory::GetUInt32Type()
{
...
const FreeForm2::TypeImpl&
FreeForm2::TypeFactory::GetBoolType()
{
...
const FreeForm2::TypeImpl&
FreeForm2::TypeFactory::GetVoidType()
{
...
const FreeForm2::TypeImpl&
FreeForm2::TypeFactory::GetStreamType()
{
...
const FreeForm2::TypeImpl&
FreeForm2::TypeFactory::GetWordType()
{
...
const FreeForm2::TypeImpl&
FreeForm2::TypeFactory::GetArrayType(const TypeImpl& p_child, 
                                     const UInt32* p_dimensions, 
                                     UInt32 p_dimensionCount)
{
    const UInt32 maxElements 
        = std::accumulate(p_dimensions, p_dimensions + p_dimensionCount, 1, std::multiplies<UInt32>());
    return m_typeManager->GetArrayType(p_child, true, p_dimensionCount, p_dimensions, maxElements);
}


const FreeForm2::TypeImpl&
FreeForm2::TypeFactory::GetStructType(const std::string& p_name,
                                      ...
                                      UInt32 p_memberCount)
{
    ...
    {
        members.push_back(StructType::MemberInfo(p_members[i].first, 
                                                 p_members[i].second, 
                                                 p_members[i].first,
                                                 0, 
                                                 0));
...
const FreeForm2::TypeImpl&
FreeForm2::TypeFactory::GetFunctionType(const TypeImpl& p_returnType,
                                        const TypeImpl* const* p_parameters,
                                        UInt32 p_parameterCount)
{
    return m_typeManager->GetFunctionType(p_returnType, p_parameters, p_parameterCount);
}


const FreeForm2::TypeImpl*
FreeForm2::TypeFactory::FindType(const std::string& p_name) const
{
...
FreeForm2::TypeFactory::GetTypeManager() const
{
