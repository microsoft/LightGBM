...
struct TrainingShareStates {
  ...
  void SetOriginHistData(hist_t* hist_data) {
  ...
  virtual void ResizeHistBuf(int n_data_block, int num_bin_aligned) = 0;
  ...
  virtual void ConstructHistogramsForBlock(const MultiValBin* sub_multi_val_bin,
    ...
    int sub_num_bin_aligned, int block_id,
...
struct TrainingShareStatesFloat : public TrainingShareStates {
  ...
  void ResizeHistBuf(int n_data_block, int sub_num_bin_aligned) override {
