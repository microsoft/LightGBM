...
pip install lightgbm -v --no-binary lightgbm --config-settings=cmake.define.CMAKE_SH=CMAKE_SH-NOTFOUND --config-settings=cmake.define.__BUILD_FOR_PYTHON=true --config-settings=cmake.args="-GMinGW Makefiles"
