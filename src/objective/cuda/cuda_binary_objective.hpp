...
#ifndef SRC_OBJECTIVE_CUDA_CUDA_BINARY_OBJECTIVE_HPP_
#define SRC_OBJECTIVE_CUDA_CUDA_BINARY_OBJECTIVE_HPP_
...
#endif  // SRC_OBJECTIVE_CUDA_CUDA_BINARY_OBJECTIVE_HPP_
