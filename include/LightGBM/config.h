...
struct Config {
  ...
  */
  ...
  // check = >0
  // desc = used only with ``multi-error`` metric
  // descl2 = threshold for top-k multi-error metric
  // descl2 = the error on each sample is ``0`` if the true class is among the top ``multi_error_top_k`` predictions, and ``1`` otherwise
  ...
  // descl2 = when ``multi_error_top_k=1`` this is equivalent to the usual multi-error metric
