 ...
 *
 * \note
 * This file is auto generated by LightGBM\.ci\parameter-generator.py from
 * LightGBM\include\LightGBM\config.h file.
 */
...
void Config::GetMembersFromString(const std::unordered_map<std::string, std::string>& params) {
  ...
  GetDouble(params, "lambdarank_position_bias_regularization",
            &lambdarank_position_bias_regularization);
...
std::string Config::SaveMembersToString() const {
  ...
  str_buf << "[monotone_constraints: "
          << Common::Join(Common::ArrayCast<int8_t, int>(monotone_constraints), ",") << "]\n";
  ...
  str_buf << "[lambdarank_position_bias_regularization: "
          << lambdarank_position_bias_regularization << "]\n";
...
const std::unordered_map<std::string, std::vector<std::string>>& Config::parameter2aliases() {
  static std::unordered_map<std::string, std::vector<std::string>> map({
      ...
      {"valid",
       {"test", "valid_data", "valid_data_file", "test_data", "test_data_file",
        "valid_filenames"}},
      {"num_iterations",
       {"num_iteration", "n_iter", "num_tree", "num_trees", "num_round", "num_rounds", "nrounds",
      ...
      {"pred_early_stop_margin", {}},
      {"output_result",
       {"predict_result", "prediction_result", "predict_name", "prediction_name", "pred_name",
        "name_pred"}},
      {"convert_model_language", {}},
