...
.. image:: ./_static/images/gpu-performance-comparison.png
   ...
   :alt: A performance chart which is a record of the wall clock time after 500 iterations on G P U for Higgs, epsilon, Bosch, Microsoft L T R, Expo and Yahoo L T R and bin size of 63 performs comparitively better.
