...
struct Config {
  ...
  */
  ...
  // desc = whether to use ternary differential feature bins
  // desc = used only in ``pairwise_lambdarank`` application and with use_differential_feature_in_pairwise_ranking = true
  bool use_ternary_differential_feature_bin = false;
