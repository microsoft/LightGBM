...
#pragma warning(disable : 4307)
        const static IntType c_maxInt = c_minInt - 1;
#pragma warning(pop)
    ...
    class ResultIterator : public boost::iterator_facade<ResultIterator, 
                                                         const Result,
    ...
    public:
        ResultIterator(std::auto_ptr<ResultIteratorImpl> p_impl);
