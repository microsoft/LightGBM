...
class GenerateConditional {
 public:
  ...
  GenerateConditional(CompilationState &p_state, llvm::Value &p_cond,
...
class ValueConversion {
 public:
  ...
  // compilation state.
  static llvm::Value &Do(llvm::Value &p_value, const TypeImpl &p_sourceType,
                         const TypeImpl &p_destType, CompilationState &p_state);
};
...
void CheckLLVMRet(const llvm::Value *p_value, const char *p_file,
                  unsigned int p_line);
void CheckLLVMRet(const llvm::Type *p_type, const char *p_file,
                  unsigned int p_line);
void CheckLLVMRet(const llvm::BasicBlock *p_block, const char *p_file,
                  unsigned int p_line);
void CheckLLVMRet(const llvm::Instruction *p_ins, const char *p_file,
                  unsigned int p_line);
};  // namespace FreeForm2
