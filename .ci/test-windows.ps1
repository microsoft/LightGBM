...
pip install lightgbm -v --no-binary lightgbm --config-settings=cmake.define.__BUILD_FOR_PYTHON=true --config-settings=cmake.args="-GVisual Studio 17 2022" --config-settings=cmake.args="-AWin32"
