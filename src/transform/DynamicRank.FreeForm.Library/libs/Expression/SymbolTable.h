...
namespace FreeForm2
{
    ...
    public:
        ...
        SymbolTable(SimpleExpressionOwner& p_owner, DynamicRank::IFeatureMap* p_featureMap);
    ...
    std::ostream& operator<<(std::ostream& p_out, const SymbolTable::Symbol& p_symbol);
};
