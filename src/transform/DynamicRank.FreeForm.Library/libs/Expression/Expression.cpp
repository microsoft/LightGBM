...
bool
FreeForm2::VariableID::operator==(VariableID p_other) const
{
...
FreeForm2::ConstantValue::GetInt(const TypeImpl& p_type) const
{
    switch (p_type.Primitive())
    {
        case Type::Int: return m_int;
        case Type::UInt64: return m_uint64;
        case Type::Int32: return m_int32;
        case Type::UInt32: return m_uint32;
...
void 
FreeForm2::Expression::AcceptReference(Visitor&) const
{
...
bool 
FreeForm2::Expression::IsConstant() const
{
    return false;
}
...
FreeForm2::Expression::GetConstantValue() const
{
    ...
    FF2_ASSERT(false && "Expression-type class must override both IsConstant and GetConstantValue");
    Unreachable(__FILE__, __LINE__);
}


const FreeForm2::ValueBounds&
FreeForm2::Expression::GetValueBounds() const
{
...
FreeForm2::Expression::GetSourceLocation() const
{
    return m_annotations.m_sourceLocation;
}


const FreeForm2::Annotations&
FreeForm2::Expression::GetAnnotations() const
{
...
FreeForm2::ValueBounds::ValueBounds(const TypeImpl& p_type, ConstantValue p_value)
{
    switch (p_type.Primitive())
    {
        case Type::Int32:
        ...
        {
            if (p_value.m_uint64
                <= static_cast<Result::UInt64Type>(std::numeric_limits<Result::IntType>::max()))
            {
...
FreeForm2::ValueBounds::ValueBounds(FreeForm2::Result::IntType p_lower, FreeForm2::Result::IntType p_upper)
    : m_lower(p_lower),
      m_upper(p_upper)
{
}
...
bool
FreeForm2::ValueBounds::operator==(const FreeForm2::ValueBounds& p_other) const
{
...
FreeForm2::Annotations::Annotations(FreeForm2::SourceLocation p_sourceLocation, FreeForm2::ValueBounds p_valueBounds)
    : m_sourceLocation(p_sourceLocation),
      m_valueBounds(p_valueBounds)
{
}
