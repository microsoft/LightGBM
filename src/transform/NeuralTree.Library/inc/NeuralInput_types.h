...
struct NeuralInputBondData 
{
    ...
    NeuralInputBondData(const NeuralInputBondData& _bond_rhs)
        : name(_bond_rhs.name.get_allocator()),
          m_segments(_bond_rhs.m_segments)    {
        InitMetadata("NeuralInputBondData", "DynamicRank.NeuralInputBondData");
    }


#ifndef BOND_NO_CXX11_RVALUE_REFERENCES
    NeuralInputBondData(NeuralInputBondData&& _bond_rhs) BOND_NOEXCEPT_IF((true
        && std::is_nothrow_move_constructible< std::string >::value
        && std::is_nothrow_move_constructible< bond::nullable<std::vector<std::string> > >::value
        ))
    ...
    explicit
    NeuralInputBondData(Allocator* _bond_allocator)
        : name(*_bond_allocator),
          m_segments(*_bond_allocator)    {
        InitMetadata("NeuralInputBondData", "DynamicRank.NeuralInputBondData");
    }
...
inline void swap(NeuralInputBondData& _bond_left, NeuralInputBondData& _bond_right)
{
...
struct BulkNeuralInputBondData 
{
    ...
    BulkNeuralInputBondData(const BulkNeuralInputBondData& /*_bond_rhs*/) = default;
#endif


#ifndef BOND_NO_CXX11_RVALUE_REFERENCES
    BulkNeuralInputBondData(BulkNeuralInputBondData&& _bond_rhs) BOND_NOEXCEPT_IF((true
    ...
    template<typename Allocator>
    explicit
    BulkNeuralInputBondData(Allocator* _bond_allocator)
...
#ifndef BOND_NO_CXX11_DEFAULTED_FUNCTIONS
    BulkNeuralInputBondData& operator=(const BulkNeuralInputBondData& _bond_rhs) = default;
#endif
...
inline void swap(BulkNeuralInputBondData& _bond_left, BulkNeuralInputBondData& _bond_right)
{
    _bond_left.swap(_bond_right);
}
...
struct NeuralInputUnaryBondData : public ::DynamicRank::NeuralInputBondData
{
    ...
    NeuralInputUnaryBondData()
        : m_iFeature()    {
        InitMetadata("NeuralInputUnaryBondData", "DynamicRank.NeuralInputUnaryBondData");
    }
...
#ifndef BOND_NO_CXX11_RVALUE_REFERENCES
    NeuralInputUnaryBondData(NeuralInputUnaryBondData&& _bond_rhs) BOND_NOEXCEPT_IF((true
    ...
    template<typename Allocator>
    explicit
    NeuralInputUnaryBondData(Allocator* _bond_allocator)
    ...
    NeuralInputUnaryBondData& operator=(const NeuralInputUnaryBondData& _bond_rhs)
    {
...
inline void swap(NeuralInputUnaryBondData& _bond_left, NeuralInputUnaryBondData& _bond_right)
{
    _bond_left.swap(_bond_right);
}
...
struct NeuralInputLinearBondData : public ::DynamicRank::NeuralInputUnaryBondData
{
    // 1: required_optional bond_meta::full_name name
    std::string name;
    ...
    NeuralInputLinearBondData()
        : m_slope(),
          m_intercept()    {
        InitMetadata("NeuralInputLinearBondData", "DynamicRank.NeuralInputLinearBondData");
    }
...
#ifndef BOND_NO_CXX11_RVALUE_REFERENCES
    NeuralInputLinearBondData(NeuralInputLinearBondData&& _bond_rhs) BOND_NOEXCEPT_IF((true
        && std::is_nothrow_move_constructible< ::DynamicRank::NeuralInputUnaryBondData >::value
        && std::is_nothrow_move_constructible< std::string >::value
    ...
    template<typename Allocator>
    explicit
    NeuralInputLinearBondData(Allocator* _bond_allocator)
    ...
    NeuralInputLinearBondData& operator=(const NeuralInputLinearBondData& _bond_rhs)
    {
    ...
    {
        return true
            && (static_cast<const ::DynamicRank::NeuralInputUnaryBondData&>(*this) == static_cast<const ::DynamicRank::NeuralInputUnaryBondData&>(_bond_other))
        // skip bond_meta::full_name field 'name'
...
protected:
    void InitMetadata(const char* _bond_name, const char* _bond_full_name)
    {
        ::DynamicRank::NeuralInputUnaryBondData::InitMetadata(_bond_name, _bond_full_name);
        this->name = _bond_full_name;
    }
};


inline void swap(NeuralInputLinearBondData& _bond_left, NeuralInputLinearBondData& _bond_right)
{
    _bond_left.swap(_bond_right);
}
...
struct NeuralInputLogLinearBondData : public ::DynamicRank::NeuralInputLinearBondData
{
    // 1: required_optional bond_meta::full_name name
    std::string name;

    NeuralInputLogLinearBondData()    {
        InitMetadata("NeuralInputLogLinearBondData", "DynamicRank.NeuralInputLogLinearBondData");
    }
...
#ifndef BOND_NO_CXX11_RVALUE_REFERENCES
    NeuralInputLogLinearBondData(NeuralInputLogLinearBondData&& _bond_rhs) BOND_NOEXCEPT_IF((true
        && std::is_nothrow_move_constructible< ::DynamicRank::NeuralInputLinearBondData >::value
        && std::is_nothrow_move_constructible< std::string >::value
        ))
    ...
    template<typename Allocator>
    explicit
    NeuralInputLogLinearBondData(Allocator* _bond_allocator)
    ...
    NeuralInputLogLinearBondData& operator=(const NeuralInputLogLinearBondData& _bond_rhs)
    {
...
#ifndef BOND_NO_CXX11_RVALUE_REFERENCES
    NeuralInputLogLinearBondData& operator=(NeuralInputLogLinearBondData&& _bond_rhs)
    {
    ...
    {
        return true
            && (static_cast<const ::DynamicRank::NeuralInputLinearBondData&>(*this) == static_cast<const ::DynamicRank::NeuralInputLinearBondData&>(_bond_other));
        // skip bond_meta::full_name field 'name'
    }
...
protected:
    void InitMetadata(const char* _bond_name, const char* _bond_full_name)
    {
        ::DynamicRank::NeuralInputLinearBondData::InitMetadata(_bond_name, _bond_full_name);
        this->name = _bond_full_name;
    }
};


inline void swap(NeuralInputLogLinearBondData& _bond_left, NeuralInputLogLinearBondData& _bond_right)
{
    _bond_left.swap(_bond_right);
}
...
struct NeuralInputRationalBondData : public ::DynamicRank::NeuralInputUnaryBondData
{
    // 1: required_optional bond_meta::full_name name
    std::string name;
    ...
    NeuralInputRationalBondData()
        : m_dblDampingFactor()    {
        InitMetadata("NeuralInputRationalBondData", "DynamicRank.NeuralInputRationalBondData");
    }
...
#ifndef BOND_NO_CXX11_RVALUE_REFERENCES
    NeuralInputRationalBondData(NeuralInputRationalBondData&& _bond_rhs) BOND_NOEXCEPT_IF((true
        && std::is_nothrow_move_constructible< ::DynamicRank::NeuralInputUnaryBondData >::value
        && std::is_nothrow_move_constructible< std::string >::value
        && std::is_nothrow_move_constructible< double >::value
        ))
    ...
    template<typename Allocator>
    explicit
    NeuralInputRationalBondData(Allocator* _bond_allocator)
        : ::DynamicRank::NeuralInputUnaryBondData(_bond_allocator),
          name(*_bond_allocator),
          m_dblDampingFactor()    {
        InitMetadata("NeuralInputRationalBondData", "DynamicRank.NeuralInputRationalBondData");
    ...
    NeuralInputRationalBondData& operator=(const NeuralInputRationalBondData& _bond_rhs)
    {
...
#ifndef BOND_NO_CXX11_RVALUE_REFERENCES
    NeuralInputRationalBondData& operator=(NeuralInputRationalBondData&& _bond_rhs)
    {
...
inline void swap(NeuralInputRationalBondData& _bond_left, NeuralInputRationalBondData& _bond_right)
{
    _bond_left.swap(_bond_right);
}
...
struct NeuralInputBucketBondData : public ::DynamicRank::NeuralInputUnaryBondData
{
    // 1: required_optional bond_meta::full_name name
    std::string name;
    ...
    NeuralInputBucketBondData()
        : m_fMinInclusive(),
          ...
          m_nMinValue(),
          m_nMaxValue()    {
        InitMetadata("NeuralInputBucketBondData", "DynamicRank.NeuralInputBucketBondData");
    }
...
#ifndef BOND_NO_CXX11_RVALUE_REFERENCES
    NeuralInputBucketBondData(NeuralInputBucketBondData&& _bond_rhs) BOND_NOEXCEPT_IF((true
        && std::is_nothrow_move_constructible< ::DynamicRank::NeuralInputUnaryBondData >::value
        && std::is_nothrow_move_constructible< std::string >::value
    ...
    template<typename Allocator>
    explicit
    NeuralInputBucketBondData(Allocator* _bond_allocator)
        : ::DynamicRank::NeuralInputUnaryBondData(_bond_allocator),
          name(*_bond_allocator),
          m_fMinInclusive(),
          m_fMaxInclusive(),
    ...
    NeuralInputBucketBondData& operator=(const NeuralInputBucketBondData& _bond_rhs)
    {
...
inline void swap(NeuralInputBucketBondData& _bond_left, NeuralInputBucketBondData& _bond_right)
{
    _bond_left.swap(_bond_right);
}
...
struct NeuralInputTanhBondData : public ::DynamicRank::NeuralInputBondData
{
    ...
    NeuralInputTanhBondData()
        : m_cInputs(),
          m_locked(),
          m_threshold()    {
        InitMetadata("NeuralInputTanhBondData", "DynamicRank.NeuralInputTanhBondData");
    }
...
#ifndef BOND_NO_CXX11_RVALUE_REFERENCES
    NeuralInputTanhBondData(NeuralInputTanhBondData&& _bond_rhs) BOND_NOEXCEPT_IF((true
        && std::is_nothrow_move_constructible< ::DynamicRank::NeuralInputBondData >::value
        && std::is_nothrow_move_constructible< std::string >::value
        && std::is_nothrow_move_constructible< uint32_t >::value
        && std::is_nothrow_move_constructible< bool >::value
    ...
    template<typename Allocator>
    explicit
    NeuralInputTanhBondData(Allocator* _bond_allocator)
        : ::DynamicRank::NeuralInputBondData(_bond_allocator),
          name(*_bond_allocator),
          m_cInputs(),
          m_locked(),
...
inline void swap(NeuralInputTanhBondData& _bond_left, NeuralInputTanhBondData& _bond_right)
{
    _bond_left.swap(_bond_right);
}
...
struct NeuralInputTanhUnaryBondData : public ::DynamicRank::NeuralInputUnaryBondData
{
    // 1: required_optional bond_meta::full_name name
    std::string name;
    ...
    NeuralInputTanhUnaryBondData()
        : m_fLocked(),
          m_dblWeights(),
          m_dblThreshold()    {
        InitMetadata("NeuralInputTanhUnaryBondData", "DynamicRank.NeuralInputTanhUnaryBondData");
    }
...
#ifndef BOND_NO_CXX11_RVALUE_REFERENCES
    NeuralInputTanhUnaryBondData(NeuralInputTanhUnaryBondData&& _bond_rhs) BOND_NOEXCEPT_IF((true
        && std::is_nothrow_move_constructible< ::DynamicRank::NeuralInputUnaryBondData >::value
        && std::is_nothrow_move_constructible< std::string >::value
        && std::is_nothrow_move_constructible< bool >::value
        && std::is_nothrow_move_constructible< double >::value
    ...
    template<typename Allocator>
    explicit
    NeuralInputTanhUnaryBondData(Allocator* _bond_allocator)
        : ::DynamicRank::NeuralInputUnaryBondData(_bond_allocator),
          name(*_bond_allocator),
          m_fLocked(),
          m_dblWeights(),
    ...
    NeuralInputTanhUnaryBondData& operator=(const NeuralInputTanhUnaryBondData& _bond_rhs)
    {
...
#ifndef BOND_NO_CXX11_RVALUE_REFERENCES
    NeuralInputTanhUnaryBondData& operator=(NeuralInputTanhUnaryBondData&& _bond_rhs)
    {
...
inline void swap(NeuralInputTanhUnaryBondData& _bond_left, NeuralInputTanhUnaryBondData& _bond_right)
{
    _bond_left.swap(_bond_right);
}
...
struct UnionNeuralInputTanhBondData 
{
    ...
    // 2: optional nullable<DynamicRank.NeuralInputTanhBondData> m_neuralInputTanhBondData
    bond::nullable< ::DynamicRank::NeuralInputTanhBondData> m_neuralInputTanhBondData;

    // 3: optional nullable<DynamicRank.NeuralInputTanhUnaryBondData> m_neuralInputTanhUnaryBondData
    bond::nullable< ::DynamicRank::NeuralInputTanhUnaryBondData> m_neuralInputTanhUnaryBondData;
    ...
    // Compiler generated copy ctor OK
#ifndef BOND_NO_CXX11_DEFAULTED_FUNCTIONS
    UnionNeuralInputTanhBondData(const UnionNeuralInputTanhBondData& /*_bond_rhs*/) = default;
#endif


#ifndef BOND_NO_CXX11_RVALUE_REFERENCES
    UnionNeuralInputTanhBondData(UnionNeuralInputTanhBondData&& _bond_rhs) BOND_NOEXCEPT_IF((true
        && std::is_nothrow_move_constructible< bool >::value
        && std::is_nothrow_move_constructible< bond::nullable< ::DynamicRank::NeuralInputTanhBondData> >::value
        && std::is_nothrow_move_constructible< bond::nullable< ::DynamicRank::NeuralInputTanhUnaryBondData> >::value
        ))
        : m_cached(std::move(_bond_rhs.m_cached)),
          m_neuralInputTanhBondData(std::move(_bond_rhs.m_neuralInputTanhBondData)),
          m_neuralInputTanhUnaryBondData(std::move(_bond_rhs.m_neuralInputTanhUnaryBondData))
    {
    }
#endif
    ...
    template<typename Allocator>
    explicit
    UnionNeuralInputTanhBondData(Allocator* _bond_allocator)
        : m_cached(),
    ...
    // Compiler generated operator= OK
#ifndef BOND_NO_CXX11_DEFAULTED_FUNCTIONS
    UnionNeuralInputTanhBondData& operator=(const UnionNeuralInputTanhBondData& _bond_rhs) = default;
#endif


#ifndef BOND_NO_CXX11_RVALUE_REFERENCES
    UnionNeuralInputTanhBondData& operator=(UnionNeuralInputTanhBondData&& _bond_rhs)
    {
    ...
    {
        return true
            && (m_cached == _bond_other.m_cached)
            && (m_neuralInputTanhBondData == _bond_other.m_neuralInputTanhBondData)
            && (m_neuralInputTanhUnaryBondData == _bond_other.m_neuralInputTanhUnaryBondData);
    }
    ...
    void swap(UnionNeuralInputTanhBondData& _bond_other)
    {
        ...
        swap(m_neuralInputTanhUnaryBondData, _bond_other.m_neuralInputTanhUnaryBondData);
    }
...
inline void swap(UnionNeuralInputTanhBondData& _bond_left, UnionNeuralInputTanhBondData& _bond_right)
{
    _bond_left.swap(_bond_right);
}
...
struct NeuralInputUseAsFloatBondData : public ::DynamicRank::NeuralInputUnaryBondData
{
    // 1: required_optional bond_meta::full_name name
    std::string name;

    NeuralInputUseAsFloatBondData()    {
        InitMetadata("NeuralInputUseAsFloatBondData", "DynamicRank.NeuralInputUseAsFloatBondData");
    }
...
#ifndef BOND_NO_CXX11_RVALUE_REFERENCES
    NeuralInputUseAsFloatBondData(NeuralInputUseAsFloatBondData&& _bond_rhs) BOND_NOEXCEPT_IF((true
        && std::is_nothrow_move_constructible< ::DynamicRank::NeuralInputUnaryBondData >::value
        && std::is_nothrow_move_constructible< std::string >::value
        ))
        : ::DynamicRank::NeuralInputUnaryBondData(std::move(_bond_rhs)),
    ...
    template<typename Allocator>
    explicit
    NeuralInputUseAsFloatBondData(Allocator* _bond_allocator)
        : ::DynamicRank::NeuralInputUnaryBondData(_bond_allocator),
          name(*_bond_allocator)    {
        InitMetadata("NeuralInputUseAsFloatBondData", "DynamicRank.NeuralInputUseAsFloatBondData");
    }
    ...
    NeuralInputUseAsFloatBondData& operator=(const NeuralInputUseAsFloatBondData& _bond_rhs)
    {
...
#ifndef BOND_NO_CXX11_RVALUE_REFERENCES
    NeuralInputUseAsFloatBondData& operator=(NeuralInputUseAsFloatBondData&& _bond_rhs)
    {
...
inline void swap(NeuralInputUseAsFloatBondData& _bond_left, NeuralInputUseAsFloatBondData& _bond_right)
{
    _bond_left.swap(_bond_right);
}
